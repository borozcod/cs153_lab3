...
int main (int argc, char **argv)
{
    ...
    1015:	8b 01                	mov    (%ecx),%eax
    int v = argc;
    1017:	89 45 f4             	mov    %eax,-0xc(%ebp)
    printf(1, "%p\n", &v);
    101a:	8d 45 f4             	lea    -0xc(%ebp),%eax
    101d:	50                   	push   %eax
    101e:	68 a8 17 00 00       	push   $0x17a8
    1023:	6a 01                	push   $0x1
    1025:	e8 d6 03 00 00       	call   1400 <printf>

    exit();
    102a:	e8 64 02 00 00       	call   1293 <exit>
    102f:	90                   	nop
    ...
    135c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1389:	0f b6 92 b4 17 00 00 	movzbl 0x17b4(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1584:	eb 1a                	jmp    15a0 <printf+0x1a0>
          s = "(null)";
    1586:	bb ac 17 00 00       	mov    $0x17ac,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15d5:	a1 9c 1a 00 00       	mov    0x1a9c,%eax
{
    ...
    15f6:	73 10                	jae    1608 <free+0x38>
{
  ...
  freep = p;
    ...
    1621:	5b                   	pop    %ebx
  freep = p;
    1622:	a3 9c 1a 00 00       	mov    %eax,0x1a9c
}
    1627:	5e                   	pop    %esi
    1628:	5f                   	pop    %edi
    1629:	5d                   	pop    %ebp
  ...
  freep = p;
    164a:	a3 9c 1a 00 00       	mov    %eax,0x1a9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1670:	8b 3d 9c 1a 00 00    	mov    0x1a9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16b9:	8b 3d 9c 1a 00 00    	mov    0x1a9c,%edi
  ...
  return freep;
    16e7:	a1 9c 1a 00 00       	mov    0x1a9c,%eax
    ...
    1714:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1717:	a3 9c 1a 00 00       	mov    %eax,0x1a9c
}
    ...
    base.s.ptr = freep = prevp = &base;
    1730:	c7 05 9c 1a 00 00 a0 	movl   $0x1aa0,0x1a9c
    1737:	1a 00 00 
    base.s.size = 0;
    173a:	bf a0 1a 00 00       	mov    $0x1aa0,%edi
    base.s.ptr = freep = prevp = &base;
    173f:	c7 05 a0 1a 00 00 a0 	movl   $0x1aa0,0x1aa0
    1746:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1749:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    174b:	c7 05 a4 1a 00 00 00 	movl   $0x0,0x1aa4
    1752:	00 00 00 
    if(p->s.size >= nunits){
